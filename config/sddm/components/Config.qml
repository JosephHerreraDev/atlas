...
QtObject {
    ...
    property string backgroundFillMode: config.stringValue("background-fill-mode") || "fill" // @possible:'fill' | 'fit' | 'stretch' @desc:Fill mode for the lock and login screen background images.
    ...
    property string lockScreenBackground: config.stringValue("LockScreen/background") || "default.jpg" // @possible:Image file in `backgrounds/` @desc:Background of the lock screen.
    ...
    property string clockFontFamily: config.stringValue("LockScreen.Clock/font-family") || "sans-serif" // @desc:Font family used for the clock.
    ...
    property string dateFontFamily: config.stringValue("LockScreen.Date/font-family") || "sans-serif" // @desc:Font family used for the date.
    ...
    property string lockMessageFontFamily: config.stringValue("LockScreen.Message/font-family") || "sans-serif" // @desc:Font family used for the custom message.
    ...
    // [LoginScreen]
    property string loginScreenBackground: config.stringValue("LoginScreen/background") || "default.jpg" // @possible:Image file in `backgrounds/` @desc:Background of the login screen.
    ...
    property string usernameFontFamily: config.stringValue("LoginScreen.LoginArea.Username/font-family") || "sans-serif" // @desc:Font family used for the username.
    ...
    property string passwordInputFontFamily: config.stringValue("LoginScreen.LoginArea.PasswordInput/font-family") || "sans-serif" // @desc:Font family of the password field.
    ...
    property string loginButtonFontFamily: config.stringValue("LoginScreen.LoginArea.LoginButton/font-family") || "sans-serif" // @desc:Font family of the label of the login button/
    ...
    property string spinnerFontFamily: config.stringValue("LoginScreen.LoginArea.Spinner/font-family") || "sans-serif" // @desc:Font family of the text to be displayed with the spinning icon.
    ...
    property string warningMessageFontFamily: config.stringValue("LoginScreen.LoginArea.WarningMessage/font-family") || "sans-serif" // @desc:Font family of the warning message.
    ...
    property string menuAreaButtonsFontFamily: config.stringValue("LoginScreen.MenuArea.Buttons/font-family") || "sans-serif" // @desc:Font family of the menu buttons.
    ...
    property string menuAreaPopupsFontFamily: config.stringValue("LoginScreen.MenuArea.Popups/font-family") || "sans-serif" // @desc:Font family of the popups.
    ...
    property string tooltipsFontFamily: config.stringValue("Tooltips/font-family") || "sans-serif" // @desc:Font family of the tooltips.
